...
template<typename T>
inline auto cross3_acc_core(const T* v1, const T* v2, T* vr) -> T* {
    auto r0 = v1[1] * v2[2] - v2[1] * v1[2] + vr[0];
    auto r1 = v1[2] * v2[0] - v2[2] * v1[0] + vr[1];
    auto r2 = v1[0] * v2[1] - v2[0] * v1[1] + vr[2];
